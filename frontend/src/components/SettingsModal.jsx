    ...
    >
      ...
      >
        <div className="p-6">
          ...
          {/* Premium entry point (S13) */}
          <section className="mb-8">
            <h3 className="text-xs font-medium mb-3 uppercase tracking-wider" style={{ color: 'var(--text-3)' }}>Plan</h3>
            <button
              type="button"
              onClick={() => window.dispatchEvent(new CustomEvent('paywall:show', { detail: { reason: null } }))}
            ...
            >
              ...
              View Trading Sync Premium plans
            </button>
          </section>
